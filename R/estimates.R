...
estimate<-function(data1,data2, domain, n1,n2, Si=0.5, lmda_1=0.5, strategy='direct_s1', sim='500'){
    ...
    if (strategy=='direct_s1'){
      ...
      for(j in 1:sim){
        ...
        for(i in domain){
          ...
          m_value <- mean(T_b, na.rm = TRUE)
          T_b[is.na(T_b)] <- m_value
    ...
    if (strategy=='direct_s2'){
      ...
      M_t_b_s2<-numeric();B_t_b_s2<-numeric()
      mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s2[,i], na.rm = TRUE)
        ee_t_b_s2[,i][is.na(ee_t_b_s2[,i])] <- mean_value[i]
    ...
    if (strategy=='weighted_s2'){
      ...
      M_t_w_s2<-numeric()
      B_t_w_s2<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_w_s2[,i], na.rm = TRUE)
        ee_t_w_s2[,i][is.na(ee_t_w_s2[,i])] <- mean_value[i]
    ...
    if (strategy=='poststratified_S2'){
      ...
      B_t_ps_s2<-numeric()
      M_t_ps_s2<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_ps_s2[,i], na.rm = TRUE)
        ee_t_ps_s2[,i][is.na(ee_t_ps_s2[,i])] <- mean_value[i]
    ...
    if (strategy=='regression_s2'){
      ...
      B_t_b_s2_reg<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s2_reg[,i], na.rm = TRUE)
        ee_t_b_s2_reg[,i][is.na(ee_t_b_s2_reg[,i])] <- mean_value[i]
    ...
    if (strategy=='ratio_s2'){
      ...
      M_t_b_s2_r<-numeric()
      B_t_b_s2_r<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s2_r[,i], na.rm = TRUE)
        ee_t_b_s2_r[,i][is.na(ee_t_b_s2_r[,i])] <- mean_value[i]
    ...
    if (strategy=='composite_regression_s2'){
      ...
      B_t_b_s2_com_reg<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s2_com_reg[,i], na.rm = TRUE)
        ee_t_b_s2_com_reg[,i][is.na(ee_t_b_s2_com_reg[,i])] <- mean_value[i]
    ...
    if (strategy=='composite_ratio_s2'){
      ...
      B_t_b_s2_com_r<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s2_com_r[,i], na.rm = TRUE)
        ee_t_b_s2_com_r[,i][is.na(ee_t_b_s2_com_r[,i])] <- mean_value[i]
    ...
    if (strategy=='regression_s3'){
      ...
      B_t_b_s3_reg<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s3_reg[,i], na.rm = TRUE)
        ee_t_b_s3_reg[,i][is.na(ee_t_b_s3_reg[,i])] <- mean_value[i]
    ...
    if (strategy=='ratio_s3'){
      ...
      M_t_b_s3_r<-numeric()
      B_t_b_s3_r<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s3_r[,i], na.rm = TRUE)
        ee_t_b_s3_r[,i][is.na(ee_t_b_s3_r[,i])] <- mean_value[i]
    ...
    if (strategy=='composite_regression_s3'){
      ...
      B_t_b_s3_com_reg<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s3_com_reg[,i], na.rm = TRUE)
        ee_t_b_s3_com_reg[,i][is.na(ee_t_b_s3_com_reg[,i])] <- mean_value[i]
    ...
    if (strategy=='composite_ratio_s3'){
      ...
      B_t_b_s3_com_r<-numeric();mean_value<-c()
      for(i in 1:length(domain)){
        mean_value[i] <- mean(ee_t_b_s3_com_r[,i], na.rm = TRUE)
        ee_t_b_s3_com_r[,i][is.na(ee_t_b_s3_com_r[,i])] <- mean_value[i]
